...
var lyr_Bueno = new ol.layer.Vector({
    ...
    popuplayertitle: 'Numeración San Xoán de Río', title: '<img src="styles/legend/ECONS_BUENO.png" /> Bueno'
});

var lyr_Regular = new ol.layer.Vector({
    declutter: false, source: source_Regular, style: estiloGrupoConservacion, interactive: true,
    maxResolution: resoluciones.maxResolution, minResolution: resoluciones.minResolution,
    popuplayertitle: 'Numeración San Xoán de Río', title: '<img src="styles/legend/ECONS_REGULAR.png" /> Regular'
});

var lyr_Malo = new ol.layer.Vector({
    declutter: false, source: source_Malo, style: estiloGrupoConservacion, interactive: true,
    maxResolution: resoluciones.maxResolution, minResolution: resoluciones.minResolution,
    popuplayertitle: 'Numeración San Xoán de Río', title: '<img src="styles/legend/ECONS_MALO.png" /> Malo'
});

var lyr_Ruina = new ol.layer.Vector({
    declutter: false, source: source_Ruina, style: estiloGrupoConservacion, interactive: true,
    maxResolution: resoluciones.maxResolution, minResolution: resoluciones.minResolution,
    popuplayertitle: 'Numeración San Xoán de Río', title: '<img src="styles/legend/ECONS_RUINA.png" /> Ruina'
});

var lyr_Vacio = new ol.layer.Vector({
    declutter: false, source: source_Vacio, style: estiloGrupoConservacion, interactive: true,
    maxResolution: resoluciones.maxResolution, minResolution: resoluciones.minResolution,
    popuplayertitle: 'Numeración San Xoán de Río', title: '<img src="styles/legend/ECONS_VACIO.png" /> Sin definir'
});
...
var lyr_Tipo = new ol.layer.Vector({
    ...
    popuplayertitle: 'Numeración San Xoán de Río', 
...
var lyr_Eib_Lugares_0 = new ol.layer.Vector({
    ...
    popuplayertitle: 'Vías/Lugares San Xoán de Río',
    interactive: true,
    opacity: 0.50000,
    title: 'Núcleos<br />'
});
...
// =========================================================================
var group_Municipio_San_Xoan_De_Rio = new ol.layer.Group({
    ...
    title: '<span class="titulo-municipio-cabecera">MUNICIPIO DE SAN XOAN DE RIO</span>'
});

// Pasamos únicamente el grupo maestro a la lista oficial de capas
var layersList = [group_Municipio_San_Xoan_De_Rio];
